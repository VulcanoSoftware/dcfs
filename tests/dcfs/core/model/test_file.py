...
class TestDCFSFileVersion:
    def test_init_with_defaults(self):
        ...
        version = DCFSFileVersion(id="test-id", updated_at=datetime.datetime.now())
    ...
    def test_updated_at_timestamp_property(self):
        ...
        version = DCFSFileVersion(id="test", updated_at=test_dt)
    ...
    def test_size_property_invalid_file_no_parts(self):
        ...
        version = DCFSFileVersion(id="test", updated_at=datetime.datetime.now())
    ...
    @patch("dcfs.core.model.file.uuid")
    @patch("dcfs.core.model.file.datetime")
    ...
    def test_from_sent_file_message_single(self, mock_datetime, mock_uuid):
        ...
        version = DCFSFileVersion.from_sent_file_message(message)
    ...
    def test_from_sent_file_message_multiple(self, mock_datetime, mock_uuid):
        ...
        version = DCFSFileVersion.from_sent_file_message(msg1, msg2)
    ...
    def test_from_dict_with_updated_at(self):
        ...
        version = DCFSFileVersion.from_dict(
            {
                "type": "FV",
                "id": "test-id",
                "size": 0,
...
class TestDCFSFileDesc:
    ...
    def test_init_full(self):
        ...
        versions = {"v1": DCFSFileVersion("v1", created_at)}

        file_desc = DCFSFileDesc(
            name="test.txt",
    ...
    def test_post_init_name_validation(self):
        ...
        with pytest.raises(InvalidName):
            DCFSFileDesc(name="-invalid")

        with pytest.raises(InvalidName):
            DCFSFileDesc(name="invalid/name")

    def test_updated_at_timestamp_no_versions(self):
        # Test timestamp property with no versions
        created_at = datetime.datetime(2023, 1, 1)
        file_desc = DCFSFileDesc(name="test.txt", created_at=created_at)
    ...
    def test_updated_at_timestamp_with_versions(self):
        ...
        version = DCFSFileVersion("v1", version_dt)
    ...
    def test_to_dict(self):
        # Test serialization to dictionary
        version1 = DCFSFileVersion("v1", datetime.datetime(2023, 1, 1))
        version2 = DCFSFileVersion("v2", datetime.datetime(2023, 1, 2))
    ...
    def test_from_dict_with_versions(self):
        ...
        file_desc = DCFSFileDesc.from_dict(
            {
                "versions": [
    ...
    def test_from_dict_empty_versions(self):
        ...
        file_desc = DCFSFileDesc.from_dict({"versions": []}, "test.txt")
    ...
    def test_empty_factory(self):
        ...
        file_desc = DCFSFileDesc.empty("test.txt")
    ...
    def test_get_latest_version_valid(self):
        ...
        version = DCFSFileVersion("v1", datetime.datetime.now())
        file_desc = DCFSFileDesc(
    ...
    def test_get_version(self):
        ...
        version = DCFSFileVersion("v1", datetime.datetime.now())
        file_desc = DCFSFileDesc(name="test.txt", versions={"v1": version})
    ...
    def test_add_version_newer(self):
        ...
        file_desc = DCFSFileDesc(name="test.txt", created_at=old_dt)
        old_version = DCFSFileVersion("v1", old_dt)
        new_version = DCFSFileVersion("v2", new_dt)
    ...
    def test_add_version_older(self):
        ...
        file_desc = DCFSFileDesc(name="test.txt", created_at=created_dt)
        old_version = DCFSFileVersion("v1", old_dt)
        new_version = DCFSFileVersion("v2", new_dt)
    ...
    @patch("dcfs.core.model.file.DCFSFileVersion.from_sent_file_message")
    ...
    def test_update_version(self):
        ...
        file_desc = DCFSFileDesc(name="test.txt")
        old_version = DCFSFileVersion("v1", datetime.datetime.now())
        new_version = DCFSFileVersion("v1", datetime.datetime.now())
    ...
    def test_get_versions_exclude_invalid(self):
        ...
        valid_version = DCFSFileVersion(
            "v1", datetime.datetime.now(), message_ids=[123]
        )
        invalid_version = DCFSFileVersion("v2", datetime.datetime.now())
