...
class TestDownloadConfig:
    def test_from_dict(self):
        ...
        assert config.download_max_concurrent_parts == 12  # default
...
class TestDiscordConfig:
    ...
    def test_from_dict_no_guild_id(self):
        ...
        assert config.guild_id == 0


class TestDCFSConfig:
    def test_from_dict_minimal(self):
        ...
        config = DCFSConfig.from_dict(data)
...
class TestConfig:
    def test_from_dict(self):
        ...
        assert config.dcfs.download.chunk_size_kb == 1024


class TestConfigFunctions:
    def test_get_config_loads_file(self, mocker):
        mock_open = mocker.patch("dcfs.config.open")
        mock_yaml_load = mocker.patch("dcfs.config.yaml.safe_load")
        mocker.patch("dcfs.config.__config", None)
