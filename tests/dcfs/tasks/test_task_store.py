...
class TestUtcNow:
    def test_utcnow(self, mocker):
        mock_datetime = mocker.patch("dcfs.tasks.task_store.datetime")
...
class TestTaskStore:
    ...
    async def test_update_task_progress_speed_calculation(
        ...
        mock_utcnow = mocker.patch("dcfs.tasks.task_store.utcnow")
...
class TestGlobalTaskStore:
    def test_global_task_store_exists(self):
        ...
        from dcfs.tasks.task_store import task_store
