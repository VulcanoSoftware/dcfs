...
from dcfs.auth import auth_basic, auth_bearer
from dcfs.auth import login as login_bearer
from dcfs.config import Config
from dcfs.core.client import Clients
...
def create_app(clients: Clients, config: Config) -> FastAPI:
    ...
    def UNAUTHORIZED(detail: str) -> Response:
        return Response(
            ...
            headers={"WWW-Authenticate": 'Basic realm="DCFS", Bearer realm="DCFS"'},
            content=detail,
        )
