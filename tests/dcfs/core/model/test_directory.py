...
class TestDCFSFileRef:
    def test_init(self):
        # Test creating a file reference
        parent_dir = DCFSDirectory.root_dir()
        file_ref = DCFSFileRef(message_id=123, name="test.txt", location=parent_dir)
    ...
    def test_to_dict(self):
        ...
        parent_dir = DCFSDirectory.root_dir()
        file_ref = DCFSFileRef(message_id=456, name="document.pdf", location=parent_dir)
...
class TestDCFSDirectory:
    def test_init_minimal(self):
        # Test creating directory with minimal parameters
        directory = DCFSDirectory(name="test_dir", parent=None)
    ...
    def test_init_with_parent(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        child = DCFSDirectory(name="child", parent=parent)
    ...
    def test_init_with_children_and_files(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        child = DCFSDirectory(name="child", parent=parent)
        file_ref = DCFSFileRef(message_id=123, name="test.txt", location=parent)

        directory = DCFSDirectory(
    ...
    def test_post_init_name_validation(self):
        ...
        with pytest.raises(InvalidName):
            DCFSDirectory(name="-invalid", parent=None)

        with pytest.raises(InvalidName):
            DCFSDirectory(name="invalid/name", parent=None)

    def test_created_at_timestamp_property(self):
        # Fresh directories get a real timestamp from the default factory.
        directory = DCFSDirectory(name="test", parent=None)
    ...
    def test_legacy_from_dict_has_epoch_timestamps(self):
        ...
        directory = DCFSDirectory.from_dict(
            {
                "type": "D",
                "name": "legacy",
                "children": [],
    ...
    def test_to_dict_empty(self):
        ...
        directory = DCFSDirectory(name="empty", parent=None)
        ...
        directory = DCFSDirectory.from_dict(
            {
                ...
                "children": [],
                "files": [
                    DCFSFileRefSerialized(type="FR", messageId=123, name="file1.txt"),
                    DCFSFileRefSerialized(type="FR", messageId=456, name="file2.pdf"),
                ],
            }
        )
    ...
    def test_create_dir_with_copy(self):
        ...
        template = DCFSDirectory(name="template", parent=None)
        template_child = DCFSDirectory(name="template_child", parent=template)
        template_file = DCFSFileRef(
    ...
    def test_create_dir_already_exists(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        existing = DCFSDirectory(name="existing", parent=parent)
    ...
    def test_find_dirs_all(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        child1 = DCFSDirectory(name="child1", parent=parent)
        child2 = DCFSDirectory(name="child2", parent=parent)
    ...
    def test_find_dirs_by_names(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        child1 = DCFSDirectory(name="target", parent=parent)
        child2 = DCFSDirectory(name="other", parent=parent)
        child3 = DCFSDirectory(name="also_target", parent=parent)
    ...
    def test_find_dir_exists(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        target = DCFSDirectory(name="target", parent=parent)
    ...
    def test_find_files_all(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        file1 = DCFSFileRef(message_id=123, name="file1.txt", location=parent)
        file2 = DCFSFileRef(message_id=456, name="file2.pdf", location=parent)
    ...
    def test_find_files_by_names(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        file1 = DCFSFileRef(message_id=123, name="target.txt", location=parent)
        file2 = DCFSFileRef(message_id=456, name="other.pdf", location=parent)
        file3 = DCFSFileRef(message_id=789, name="also_target.doc", location=parent)
    ...
    def test_find_files_empty_result(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        file_ref = DCFSFileRef(message_id=123, name="existing.txt", location=parent)
        parent.files.append(file_ref)
    ...
    def test_find_file_exists(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        target = DCFSFileRef(message_id=123, name="target.txt", location=parent)
    ...
    def test_create_file_ref_already_exists(self):
        ...
        parent = DCFSDirectory(name="parent", parent=None)
        existing = DCFSFileRef(message_id=123, name="existing.txt", location=parent)
    ...
    def test_delete_root_directory(self):
        ...
        root = DCFSDirectory.root_dir()
        child = DCFSDirectory(name="child", parent=root)
        file_ref = DCFSFileRef(message_id=123, name="test.txt", location=root)
    ...
    def test_absolute_path_single_level(self):
        ...
        root = DCFSDirectory.root_dir()
        child = DCFSDirectory(name="folder", parent=root)
    ...
    def test_absolute_path_nested(self):
        ...
        root = DCFSDirectory.root_dir()
        level1 = DCFSDirectory(name="level1", parent=root)
        level2 = DCFSDirectory(name="level2", parent=level1)
        level3 = DCFSDirectory(name="level3", parent=level2)
    ...
    def test_absolute_path_empty_name(self):
        ...
        with pytest.raises(IndexError):
            DCFSDirectory(name="", parent=root)

    def test_absolute_path_complex_hierarchy(self):
        # Test absolute path in complex directory hierarchy
        root = DCFSDirectory.root_dir()
        documents = DCFSDirectory(name="Documents", parent=root)
        projects = DCFSDirectory(name="Projects", parent=documents)
        myproject = DCFSDirectory(name="MyProject", parent=projects)
        src = DCFSDirectory(name="src", parent=myproject)
