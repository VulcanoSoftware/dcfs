...
from dcfs.core.api.directory import DirectoryApi
...
from dcfs.core.model import DCFSDirectory, DCFSFileRef, DCFSFileVersion
from dcfs.errors import DirectoryIsNotEmpty
...
class TestDirectoryApi:
    ...
    async def test_rm_empty_directory_no_messages_to_delete(
        ...
        empty_dir = DCFSDirectory.root_dir()
    ...
    async def test_rm_dangerously_collects_subtree_message_ids(
        ...
        async def fake_collect(fr: DCFSFileRef):
